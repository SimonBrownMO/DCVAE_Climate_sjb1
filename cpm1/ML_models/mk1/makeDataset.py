...
def getDataAvailability(source):
    ...
    dir = "/home/mo-sbrown/SCRATCH/cpm1/%s/norm_tensors" % (source) # args.variable
...
def getDataset(specification, purpose):
    ...
    inFiles = getFileNames("/home/mo-sbrown/SCRATCH/cpm1", vars)
    ...
    if (
        ...
        #     specification["maxEnsembleCombinations"],
        # )
        outFiles = getFileNames("/home/mo-sbrown/SCRATCH/cpm1", vars)
